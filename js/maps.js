// Objet maps : Map <google + marqueurs
var Maps = {
...
var Station = {
  ...
  init: function() {
    this.ajaxGet();
    this.traitementDonneesStation();
    this.insertionDonneesStation();
    this.autorisationReservation();
  },
...
Station.ajaxGet("https://api.jcdecaux.com/vls/v1/stations?contract=lyon&apiKey=484cbc445ca32594353c1453dbd730150c0ebf1e", function(reponse) {
